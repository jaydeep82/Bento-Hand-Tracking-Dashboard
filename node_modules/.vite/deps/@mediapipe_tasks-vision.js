...
function dt(t2, e2) {
  if (null != t2) {
    if ("string" == typeof t2)
      ...
      if (C(t2))
        t2 = t2.length ? new N(new Uint8Array(t2), O) : U();
      else {
        if (!e2)
          throw Error();
        t2 = void 0;
...
function At(t2) {
  ...
  } else if (vt(e2) && !Number.isSafeInteger(e2))
    throw Error(String(e2));
...
function Bt(t2, e2) {
  if (t2 >>>= 0, (e2 >>>= 0) <= 2097151)
    ...
    at() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, t2 >= 1e7 && (n2 += t2 / 1e7 >>> 0, t2 %= 1e7), n2 >= 1e7 && (e2 += n2 / 1e7 >>> 0, n2 %= 1e7), n2 = e2 + Gt(n2) + Gt(t2));
  return n2;
}
function Gt(t2) {
...
function Vt(t2) {
  if (t2.length < 16)
    ...
    t2 = BigInt(t2), Mt = Number(t2 & BigInt(4294967295)) >>> 0, Pt = Number(t2 >> BigInt(32) & BigInt(4294967295));
  else {
    const e2 = +("-" === t2[0]);
    Pt = Mt = 0;
    const n2 = t2.length;
...
function ue(t2) {
  ...
  if (Qt(t2)) {
    if ("string" === e2)
      return e2 = Yt(Number(t2)), zt(e2) && e2 >= 0 ? t2 = String(e2) : (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), ne(t2) || (Vt(t2), t2 = Bt(Mt, Pt))), t2;
    if ("number" === e2)
...
function pe(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.W === ut)
    return t2;
  if (!Array.isArray(t2))
    return n2 ? 2 & r2 ? ((t2 = e2[Y]) || (it((t2 = new e2()).u), t2 = e2[Y] = t2), e2 = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = 0 | t2[Q];
...
function ge(t2, e2, n2) {
  if (e2)
    ...
    t2 = typeof (e2 = t2), e2 = null == e2 ? e2 : "bigint" === t2 ? At(Ht(64, e2)) : Qt(e2) ? "string" === t2 ? ae(e2) : ce(e2) : void 0;
...
var Ae = class extends Ee {
  ...
  La() {
    var t2 = Ce;
    if (0 !== this.size)
      return Array.from(super.entries(), (e2) => (e2[0] = t2(e2[0]), e2[1] = t2(e2[1]), e2));
  }
  da(t2 = ke) {
...
function Ne(t2, e2, n2, r2) {
  if (null == t2) {
    ...
    if (!Array.isArray(t2))
      throw Error("narr");
    if (8192 & (i2 = 0 | t2[Q]) || !(64 & i2) || 2 & i2 || H(J), 1024 & i2)
      throw Error("farr");
    if (64 & i2)
      return t2;
    ...
    t: {
      ...
      if (s2) {
        var o2 = s2 - 1;
        if (lt(r2 = n2[o2])) {
          if ((o2 -= e2 = 512 & (i2 |= 256) ? 0 : -1) >= 1024)
            throw Error("pvtlmt");
          for (var a2 in r2)
            (s2 = +a2) < o2 && (n2[s2 + e2] = r2[a2], delete r2[a2]);
          i2 = -16760833 & i2 | (1023 & o2) << 14;
          break t;
        }
      }
      if (e2) {
        if ((a2 = Math.max(e2, s2 - (512 & i2 ? 0 : -1))) > 1024)
          throw Error("spvt");
...
function an(t2, e2, n2) {
  ...
  let s2;
  if (null != i2 && i2.W === ut)
    return (e2 = je(i2)) !== i2 && We(t2, r2, n2, e2), e2.u;
  if (Array.isArray(i2)) {
    const t3 = 0 | i2[Q];
    s2 = 2 & t3 ? De(Ge(i2, t3, false), e2, true) : 64 & t3 ? i2 : De(s2, e2, true);
  } else
    s2 = De(void 0, e2, true);
...
function un(t2, e2, n2, r2, i2, s2, o2) {
  ...
  if (o2 && !(8 & h2 || !i2.length && (1 === c2 || 4 === c2 && 32 & h2))) {
    for (Ze(h2) && (i2 = ct(i2), h2 = pn(h2, e2), e2 = We(t2, e2, r2, i2)), n2 = i2, o2 = h2, u2 = 0; u2 < n2.length; u2++)
      (h2 = n2[u2]) !== (l = je(h2)) && (n2[u2] = l);
...
function Ln(t2) {
  ...
  if (t2.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t2), O: false };
  if (t2.constructor === N)
    return { buffer: D(t2) || new Uint8Array(0), O: true };
...
function Xr(t2, e2, n2) {
  !function(t3, e3, n3) {
    ...
    for (let n3 = 0; n3 < e3.length; n3++)
      or(t3, D(e3[n3]) || new Uint8Array(0));
  }(e2, t2);
}
function Hr(t2, e2) {
  if (Array.isArray(e2)) {
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        Array.isArray(n3) ? s2 = !!(2 & (0 | n3[Q])) : n3 = [];
      if (i2) {
        if (!n3.length)
          return Ie();
        s2 || (s2 = true, it(n3));
      } else
        s2 && (s2 = false, n3 = Qe(n3));
...
function xo(t2) {
  ...
  if ((e2 = (_a2 = hn(t2, cs, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: _n(e2, 1) ?? 0, originY: _n(e2, 2) ?? 0, width: _n(e2, 3) ?? 0, height: _n(e2, 4) ?? 0, angle: 0 }), (_b = hn(t2, cs, 4)) == null ? void 0 : _b.g().length)
    for (const e3 of hn(t2, cs, 4).g())
      s2.keypoints.push({ x: ze(e3, 1) ?? 0, y: ze(e3, 2) ?? 0, score: ze(e3, 4) ?? 0, label: vn(e3, 3) ?? "" });
  return s2;
}
function Lo(t2) {
  const e2 = [];
  for (const n2 of ln(t2, ds, 1))
    e2.push({ x: En(n2, 1) ?? 0, y: En(n2, 2) ?? 0, z: En(n2, 3) ?? 0, visibility: En(n2, 4) ?? 0 });
  return e2;
}
function Ro(t2) {
  const e2 = [];
  for (const n2 of ln(t2, us, 1))
    e2.push({ x: En(n2, 1) ?? 0, y: En(n2, 2) ?? 0, z: En(n2, 3) ?? 0, visibility: En(n2, 4) ?? 0 });
  return e2;
}
function Fo(t2) {
...
async function Wo(t2, e2, n2, r2) {
  return t2 = await (async (t3, e3, n3, r3, i2) => {
    if (e3 && await No(e3), !self.ModuleFactory)
      throw Error("ModuleFactory not set.");
    if (n3 && (await No(n3), !self.ModuleFactory))
      throw Error("ModuleFactory not set.");
...
var Zo = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = hn(this.baseOptions, Fs, 1)) == null ? void 0 : _c2.g()) || ((_d = hn(this.baseOptions, Fs, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
var ca = class {
  ...
  m() {
    const t2 = this.g;
    if (this.h = Qo(t2.createProgram(), "Failed to create WebGL program"), this.Z = ea(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t2.VERTEX_SHADER), this.Y = ea(this, this.G(), t2.FRAGMENT_SHADER), t2.linkProgram(this.h), !t2.getProgramParameter(this.h, t2.LINK_STATUS))
...
var Ia = class {
  ...
  wa(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2)
        n2.fillStyle = ba(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = ba(e2.color, { index: i2, from: s2 }), n2.lineWidth = ba(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, ba(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  va(t2, e2, n2) {
...
function Ka(t2, e2, n2, r2) {
  if (t2.U) {
    ...
    if (n2 == null ? void 0 : n2.regionOfInterest) {
      ...
      An(s2, 1, 0.5), An(s2, 2, 0.5), An(s2, 4, 1), An(s2, 3, 1);
...
var Ja = class extends Zo {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && wn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas)
...
var Za = class extends Ja {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect_in"), Wi(n2, "DETECTIONS:detections"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3)
        t3 = hs(e4), this.j.detections.push(xo(t3));
      Yo(this, e3);
...
var uc = class extends Ja {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = fs(e4), this.j.faceLandmarks.push(Lo(t3));
      Yo(this, e3);
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = ss(e4), this.j.faceBlendshapes.push(So(t3.g() ?? []));
      Yo(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = hn(Ds(e4), ps, 2)) && this.j.facialTransformationMatrixes.push({ rows: _n(t3, 1) ?? 0 ?? 0, columns: _n(t3, 2) ?? 0 ?? 0, data: $e(t3, 3, qt, Ye()).slice() ?? [] });
      Yo(this, e3);
...
var lc = class extends Ja {
  ...
  Ka(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Ya(this, t2, r2 ?? {}), !this.h)
      return this.s;
  }
  m() {
    var t2 = new Qi();
...
function gc(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != _n(n3, 1) ? _n(n3, 1) ?? 0 : -1, t2.push({ score: En(n3, 2) ?? 0, index: r2, categoryName: vn(n3, 3) ?? "" ?? "", displayName: vn(n3, 4) ?? "" ?? "" });
    n2.push(t2);
  }
  return n2;
}
var mc = class extends Ja {
  ...
  o(t2) {
    ...
    if (Tn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && An(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && An(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && An(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = hn(this.h, Ws, 3)) == null ? void 0 : _b.g());
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "HAND_GESTURES:hand_gestures"), Wi(n2, "LANDMARKS:hand_landmarks"), Wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Wi(n2, "HANDEDNESS:handedness"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) {
        t3 = fs(e4);
        const n3 = [];
        for (const e5 of ln(t3, ds, 1))
          n3.push({ x: En(e5, 1) ?? 0, y: En(e5, 2) ?? 0, z: En(e5, 3) ?? 0, visibility: En(e5, 4) ?? 0 });
...
var _c = class extends Ja {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "LANDMARKS:hand_landmarks"), Wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Wi(n2, "HANDEDNESS:handedness"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = fs(e4), this.landmarks.push(Lo(t3));
      Yo(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      Yo(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = ls(e4), this.worldLandmarks.push(Ro(t3));
      Yo(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      Yo(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: En(e5, 2) ?? 0, index: _n(e5, 1) ?? 0 ?? -1, categoryName: vn(e5, 3) ?? "" ?? "", displayName: vn(e5, 4) ?? "" ?? "" });
        i2.push(n4);
      }
...
var Ac = class extends Ja {
  ...
  m() {
    ...
    tn(n2, 1, de("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t3, e3) {
      if (null != e3)
        if (Array.isArray(e3))
          He(t3, 2, Pe(e3, Oe, void 0, void 0, false));
        else {
          if (!("string" == typeof e3 || e3 instanceof N || C(e3)))
    ...
    Xi(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), qi(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = As(t3), this.embeddings = function(t4) {
        return { embeddings: ln(t4, ws, 1).map((t5) => {
          ...
          if (void 0 !== cn(t5, vs, nn(t5, 1)))
            t5 = $e(t5 = hn(t5, vs, nn(t5, 1)), 1, qt, Ye()), e4.floatEmbedding = t5.slice();
          else {
...
var Vc = class extends Ja {
  ...
  segment(t2, e2, n2, r2) {
    ...
    const s2 = new Bc();
    var o2 = new Ic();
    if (Tn(o2, 1, 255), dn(s2, 0, 12, o2), e2.keypoint && e2.scribble)
    ...
    if (e2.keypoint) {
      ...
      for (a2 of (o2 = new Nc(), e2.scribble))
        wn(e2 = new Uc(), 3, true), An(e2, 1, a2.x), An(e2, 2, a2.y), yn(o2, 1, Uc, e2);
      fn(s2, 15, Gc, o2);
    }
